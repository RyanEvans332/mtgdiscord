...
namespace mtgdiscord.MultiFacedCards
{
    public class MultiFacedCard : mtgdiscord.Cards.ICard
    {
        public MultiFacedCard() {}
        public override List<string> getCardImageURIs()
        {
            var list = new List<string>();

            foreach(var cardFace in this.card_faces)
            {
                list.Add(cardFace.image_uris.normal);
            }
